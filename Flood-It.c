...
int main(int argc,char**argv){
  ...
  if (exo==1){
     printf("%d essais\n", sequence_aleatoire_rec(M, G, dim, nbcl, aff)); //partie exo 1
  }
  if (exo==2){ 
    printf("%d essais\n", sequence_aleatoire_rapide(M, G, dim, nbcl, aff)); //partie exo 2
    
  }

  if(exo==3){
    printf("%d essais\n", strategie_max_bordure(M, G, dim, nbcl, aff)); //partie exo 3
  }
  if(exo==4){
    printf("%d essais\n", strategie_max_bordure_zone(M, G, dim, nbcl, aff)); //partie exo 4
  }
  if(exo==5){
    printf("%d essais\n", strategie_exo5(M, G, dim, nbcl, aff)); //partie exo 5
  }
